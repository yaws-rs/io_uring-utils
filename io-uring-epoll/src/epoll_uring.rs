...
impl EpollUringHandler {
    ...
    ///
    /// EpollUringHandler::new(16, 16, 16, 16, 16).expect("Unable to create EpullUringHandler");
    /// ```    
    pub fn new(
        capacity: u32,
        fd_capacity: usize,
    ...
    ///
    /// EpollUringHandler::from_io_uring(iou, 16, 16, 16, 16).expect("Unable to create from io_uring Builder");
    /// ```    
    pub fn from_io_uring(
        ...
        let uring =
            UringHandler::from_io_uring(iou, fd_capacity, req_capacity, buf_capacity, fut_capacity)
